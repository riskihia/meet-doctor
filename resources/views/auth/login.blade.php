            ...
            <form method="POST" action="{{ route('login') }}" class="grid gap-6">
              ...
              <label class="block">
                <input
                    id="email"
                    type="email"
                    class="block w-full rounded-full py-4 mb-2 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
